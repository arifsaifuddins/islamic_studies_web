    ...
    <>
      <div className="bg-white py-3 flex">
        <div className="flex flex-row-reverse gap-4 items-center mx-auto">
          <a href='https://iua.edu.sd' target="_blank" className='text-md font-bold border-l-2 pl-4'>جـــامعـــــة إفـــــريقـــــيـــــا الـعــــــالمــــــيــــــة</a>
          <Link to="/" className='text-md'>كلـــية الـدراســات الإســـلامـية</Link>
        </div>
      </div>
