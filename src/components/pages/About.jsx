    ...
    <>
      ...
      <div className="bg-white border-t-4 border-yellow-600">
        <div className="mx-auto w-[1200px] relative">
          ...
          <div className="mx-auto w-[900px] text-lg text-end leading-9 py-40">
            <img src="/exmp.jpg" alt="photo" className='object-cover w-full mb-14 h-60' />
            <p className="mb-12" data-aos="fade-down">
        ...
        <div className="bg-slate-100 border-t-4 border-yellow-600">
          <div className="mx-auto w-[1200px] relative">
            ...
            <div className="mx-auto w-[900px] text-lg text-end leading-9 py-40">
              <h2 className='text-2xl font-bold text-yellow-600 mb-12'>الرؤيات</h2>
              <ul>
                <li className='flex flex-row-reverse relative mb-8' data-aos="fade-up">
                  <div className="h-6 w-6 rounded-full bg-yellow-600 absolute -top-3"></div>
                  <p className='py-2 px-6 rounded-lg bg-white mr-3'>التميز في الدراسات الإسلامية، في إطار من الأصالة والمعاصرة، وطنياً وإقليمياً وعالمياً</p>
                </li>
                <li className='flex flex-row-reverse relative mb-8' data-aos="fade-up">
                  <div className="h-6 w-6 rounded-full bg-yellow-600 absolute -top-3"></div>
                  <p className='py-2 px-6 rounded-lg bg-white mr-3'>تقديم خدمة تعليمية وبحثية متميزة، في الدراسات الإسلامية؛ تسهم في البناء المعرفي والحضاري، وطنياً وإقليمياً وعالمياً، على أسس تتسم بالوسطية والاعتدال</p>
                </li>
                <li className='flex flex-row-reverse relative mb-8' data-aos="fade-up">
                  <div className="h-6 w-6 rounded-full bg-yellow-600 absolute -top-3"></div>
                  <p className='py-2 px-6 rounded-lg bg-white mr-3'>التميز والكفاءة، الأصالة والمعاصرة، الوسطية والاعتدال</p>
                </li>
              </ul>
              <h2 className='text-2xl font-bold text-yellow-600 mb-12 mt-32'>الأهداف</h2>
              <ul>
                <li className='flex flex-row-reverse relative mb-8' data-aos="fade-up">
                  <div className="h-6 w-6 rounded-full bg-yellow-600 absolute -top-3"></div>
                  <p className='py-2 px-6 rounded-lg bg-white mr-3'>التميز في الدراسات الإسلامية، في إطار من الأصالة والمعاصرة، وطنياً وإقليمياً وعالمياً</p>
