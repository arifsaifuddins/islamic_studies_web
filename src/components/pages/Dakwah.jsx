  ...
  return (
    <>
      <div className='h-96 flex bg-stone-700 bg-opacity-50 text-white'>
        <h1 className='text-5xl m-auto'>قسم الدعوة والسيرة</h1>
      </div>
      <div className="bg-white border-t-4 border-yellow-600">
        <div className="mx-auto w-[1200px] relative">
          <h2 className='px-3 py-1 absolute right-0 rounded-bl-lg bg-yellow-600 w-max text-white'>قسم الدعوة والسيرة</h2>
