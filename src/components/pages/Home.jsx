  ...
  return (
    <div className='pb-80 pt-28 bg-stone-700 bg-opacity-50 text-white'>
      <div className="flex flex-col font-bold gap-3 items-center mx-auto mt-10">
        ...
        <p className='text-xl text-yellow-600'>الخرطوم | السودان</p>
        ...
        <div className="flex flex-row-reverse items-center gap-4 mt-14">
          ...
          <Link to='/contact' className='px-8 py-2 border border-yellow-600 hover:bg-stone-300 hover:text-yellow-600 rounded-lg flex flex-row-reverse items-center gap-2'><FiPhone /> اتصل بنا</Link>
        </div>
      </div>
    </div>
  );
