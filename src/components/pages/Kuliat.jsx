      ...
      <div className="bg-white border-t-4 border-yellow-600">
        <div className="mx-auto  xl:w-[1200px] w-full px-4 xl:px-0 relative">
          ...
          <div className="mx-auto lg:w-[900px] w-full text-lg text-end leading-9 py-32">
            <div className="mb-20">
              <h3 className="mb-12 text-xl font-bold text-yellow-600">جاء إنشاء هذه الكلية تلبية لحاجة أبناء </h3>
              <img src="/exmp.jpg" alt="photo" className='object-cover md:w-[50%] mb-6 md:mb-0 md:ml-8 h-60 md:float-right w-full' />
              <p className="mb-12">
