    ...
    <>
      ...
      <div className="bg-white border-t-4 border-yellow-600">
        <div className="mx-auto xl:w-[1200px] w-full px-4 xl:px-0 relative">
          ...
          <div className="mx-auto lg:w-[900px] w-full text-lg text-end leading-9 py-32">
            ...
            <div className="flex flex-row-reverse items-center justify-between mt-10 md:gap-6 gap-4" data-aos="fade-up">
            ...
            <div className="flex flex-row-reverse py-1 bg-yellow-600 text-white mx-auto md:mx-0 items-center text-xl w-max mt-0">
