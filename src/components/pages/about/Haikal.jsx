    ...
    <>
      ...
      <div className="bg-white border-t-4 border-yellow-600">
        <div className="mx-auto xl:w-[1200px] w-full px-4 xl:px-0 relative">
          <h2 className='px-3 py-1 absolute rounded-bl-lg bg-yellow-600 w-max text-white'>هيكل كلية الدراسات الإسلامية الإداري</h2>
                  ...
                  <div key={a._id} className="relative mb-24">
                    ...
                    <ul className='pt-3 flex flex-col gap-4 rounded-lg overflow-hidden'>
                      ...
                      </li>
                      {
                        a.works.map((a, i) => {
                          return (
                            <li key={i} className='flex flex-row bg-white border-r-8 rounded-l-lg w-full border-yellow-600'>
