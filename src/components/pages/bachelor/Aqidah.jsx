    ...
    <>
      ...
      <div className="bg-white border-t-4 border-yellow-600">
        <div className="mx-auto  xl:w-[1200px] w-full px-4 xl:px-0 relative">
          <h2 className='px-3 py-1 absolute xl:right-0 right-4 rounded-bl-lg bg-yellow-600 w-max text-white'>قسم العقيدة والفكر الإسلامي</h2>
                    ...
                    <ul className='bg-white border-x'>
                      ...
                      </li>
                      {
                        akidah_bachelor_5?.map(a => {
                          return (
                            <li key={a._id} className='flex flex-row-reverse items-center gap-6 border-b-4 relative px-6 py-2'>
                              {
