    ...
    <>
      ...
      <div className="bg-white border-t-4 border-blue-600">
        <div className="mx-auto  xl:w-[1200px] w-full px-4 xl:px-0 relative">
          <h2 className='px-3 py-1 absolute rounded-bl-lg bg-blue-600 w-max text-white'>الفصل الأول والثاني والثالث والرابع</h2>
          <div className="mx-auto lg:w-[900px] w-full leading-9 py-32">
            {
              all_major_1 != null ? all_major_1?.length > 0 && (
                <>
                  <div className="mb-20">
