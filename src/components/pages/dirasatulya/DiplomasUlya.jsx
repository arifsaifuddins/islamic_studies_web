    ...
    <>
      ...
      <div className="bg-white border-t-4 border-blue-600">
        <div className="mx-auto xl:w-[1200px] w-full px-4 xl:px-0 relative">
          <h2 className='px-3 py-1 absolute rounded-bl-lg bg-blue-600 w-max text-white'>دبلوم الدراسات الإسلامية</h2>
      ...
      <div className="bg-slate-100 border-t-4 border-blue-600">
        <div className="mx-auto xl:w-[1200px] w-full px-4 xl:px-0 relative">
          <h2 className='px-3 py-1 absolute xl:left-0 left-4 rounded-br-lg bg-blue-600 w-max text-white'>دبلوم الدعوة والسيرة العالي (الضباط)</h2>
          <div className="mx-auto lg:w-[900px] w-full leading-9 py-32">
            {
